      ...
      <div class="wrapper">
        <div class="demo">
          ...
          <div class="demo-content">
			<div class="view-demo">
		  			<div>
						<h3><?=$_SESSION['audio_name']?></h3>
					</div>
					<div class="controls">
						<audio controls>
							<source src="src/temp_audio/<?=$_SESSION['audio_url']?>">
						</audio>
						
						<div class="form">
							<form action="delete.php" method="post" class="view-form">
								<input type="submit" name="delete" value="Удалить" class="submit">
							</form>
							<form action="confirm.php" method="post" class="view-form">
								<input type="submit" name="confirm" value="Подтвердить" class="submit">
							</form>
						</div>
					</div>
			</div>
